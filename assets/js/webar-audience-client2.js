...
export function joinChannel() {
  token= "006e76fbfaa876b4c68a5d92d92aa6ad3b1IAAzcoKpIaQ0b2OljBEtoN9qfOCSZiQ/roKj9rV7Ait06VE4yRUAAAAAEAAyf2YEIrSDYgEAAQAhtINi";
...
export function joinRTMChannel(uid){
...
export function rotateModel(uid, direction) {
...
export function moveModel(uid, direction) {
  var model = document.getElementById(uid)
  switch (direction){
    case 'forward':
