...
import { getAuth,
 ...
 var MESSAGE_TEMPLATE =
     '<div class="message-container">' +
       '<div class="spacing">  <div class="circle"><img id="im" src="https://en.gravatar.com/userimage/8283692/4c9d9ec1cd3fd02acb5ac9572e3583da?size=200" alt=""/><svg viewBox="0 0 100 100" xmlns="" style="enable-background:new -580 439 577.9 194;"xml:space="preserve"> <circle cx="50" cy="50" r="40" /></svg></div></div>' +
 ...
 function displayMessage(id, timestamp, name, text, picUrl) {
   ...
   // profile picture
   if (picUrl) {
    div.querySelector(".circle").getElementById('im').src = 'url(' + addSizeToGoogleProfilePic(picUrl) + ')';
   }
